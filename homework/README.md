...
# Ответы
1. Проще начать с описания классов, а потом делать проверки на них
2. Потому что нам важно хранить продукты в формате ключ-значение, где значение - это количество товара. Со списком было бы сложнее.
3. Метод хеширования необходим для исключения ошибки при использовании объектов класса Product в качестве ключей